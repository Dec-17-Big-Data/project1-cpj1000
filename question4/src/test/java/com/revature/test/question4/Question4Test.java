...
import com.revature.question4.Question4Mapper;
import com.revature.question4.Question4Reducer;
...
public class Question4Test {
	...
	public void setUp() {
		// Mapper
		Question4Mapper mapper = new Question4Mapper();
		mapDriver = new MapDriver<LongWritable, Text, Text, Text>();
		mapDriver.setMapper(mapper);

		// Reducer
		Question4Reducer reducer = new Question4Reducer();
